...
type TableBlockParserInfo struct {
	...
	ParserType  ParserType `json:"parser_type" gorm:"column:parser_type;uniqueIndex:uk_parser_number;type:smallint(6) NOT NULL DEFAULT '0' COMMENT 'register-99 sub-acc-98 ckb-0 eth-1 btc-2 tron-3 bsc-5 4-wx polygon-6'"`
