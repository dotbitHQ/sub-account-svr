...
type RuleWhitelist struct {
	...
	ParentAccountId string    `gorm:"index:idx_pid_acc_id;column:parent_account_id;type:varchar(255);comment:父账号id;NOT NULL" json:"parent_account_id"`
	...
	AccountId       string    `gorm:"index:idx_pid_acc_id;column:account_id;type:varchar(255);comment:账号id;NOT NULL" json:"account_id"`
