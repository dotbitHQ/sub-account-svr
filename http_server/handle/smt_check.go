...
func (h *HttpHandle) SmtCheck(ctx *gin.Context) {
	...
	if err = h.doSmtCheck(ctx.Request.Context(), &req, &apiResp); err != nil {
...
func (h *HttpHandle) doSmtCheck(ctx context.Context, req *ReqSmtCheck, apiResp *api_code.ApiResp) error {
